...
class ContentRepositoryImpl implements ContentRepository {
  ...
  @override
  Future<Either<Failure, void>> deleteContent({required String courseId, required String contentId}) {
    // TODO: implement deleteContent
    throw UnimplementedError();
  }
  
  @override
  Future<Either<Failure, void>> reorderContent({required String courseId, required List<String> contentIds}) {
    // TODO: implement reorderContent
    throw UnimplementedError();
  }
  
  @override
  Future<Either<Failure, ContentEntity>> updateContent({required String courseId, required String contentId, String? title, String? description}) {
